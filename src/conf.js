...
async function validateUpdateModule(conf) {
  logger.info('Validating configuration file...')
...
async function validateSafeTransaction(conf) {
  logger.info('Validating configuration file...')
...
async function validateStatus(conf) {
  logger.info('Validating configuration file...')
...
async function validateSignOffline(conf) {
  ...
  const safeOwners = (await safeInstance.getOwners()).map(owner => owner.toLowerCase())
